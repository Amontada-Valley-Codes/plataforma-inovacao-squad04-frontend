...
export default function IdeiasPerfomance({ desempenhoMensal }: IdeiasPerfomanceProps) {
  const [isOpen, setIsOpen] = useState(false);

  // Transforma o objeto em arrays
  const categories = Object.keys(desempenhoMensal);
  const data = Object.values(desempenhoMensal);     
  ...
  const series = [{ name: "Total de Ideias", data }];
