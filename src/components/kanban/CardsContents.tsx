import { BriefcaseBusiness, Bug, Building2, Calendar, ChartNoAxesCombined, ChartPie, CircleCheck, CircleCheckBig, CircleUserRound, ClipboardList, Lamp, Lightbulb, ListCheck, Menu, SquarePen, Tag, Target, Trash2, TriangleAlert, Trophy, Users, X } from "lucide-react";
...
export const CardIdeationContent = ({ challangeTitle, challengeId, category, description }: CardIdeationContentProps) => {
  return (
    <div className="w-full flex flex-col overflow-y-auto scrollbar-hidden">
      {/* header */}
      <div className="mb-6">
