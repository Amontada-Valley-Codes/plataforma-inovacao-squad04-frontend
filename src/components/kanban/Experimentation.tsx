...
import StatusReportPoC from "./StatusReport";
    ...
    <div  className="w-full flex flex-col overflow-y-auto">
      ...
      <div className="flex flex-col xl:flex-row xl:justify-between mb-6">
        ...
        <div className="relative flex items-center">
          <div className="flex gap-4 items-start xl:justify-center w-full max-w-md">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm mt-1 whitespace-nowrap">Status Report</span>
            </div>
        ...
        <div>
          ...
          {page === '2' && <StatusReportPoC responsibleName={creator} />}
