...
export function FormBuilderHeader({ title, description, version, fieldsCount, onAddField, onSaveForm, onPreview }: FormBuilderHeaderProps) {
  return (
    <div className="border-b border-gray-200 dark:border-gray-800 bg-gradient-to-r from-brand-50 to-blue-light-50 dark:from-brand-950/50 dark:to-blue-light-950/50 p-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Button 
            onClick={onAddField} 
            className="gap-2 px-4 py-2.5 text-sm font-medium bg-brand-500 hover:bg-brand-600 text-white shadow-theme-sm"
          >
