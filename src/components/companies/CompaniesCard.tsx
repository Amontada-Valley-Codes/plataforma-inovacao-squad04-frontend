      ...
      <div className="w-full rounded-2xl shadow-md overflow-hidden bg-white dark:bg-gray-900">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 px-12 mt-28">
            ...
            <h3 className="text-xl font-bold text-blue-900 dark:text-blue-400 mt-10">
              Desafios
            </h3>
            <div className="grid md:grid-cols-3 gap-6 mt-4">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="bg-blue-50 dark:bg-gray-800 rounded-xl p-5 relative border border-blue-100 dark:border-gray-700 shadow-sm hover:shadow-md transition"
                >
                  ...
                  <button className="absolute top-3 right-3 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200">
                    ...
                  </button>
                </div>
              ))}
          ...
          <div className="w-full lg:w-96 border-l dark:border-gray-700 p-8 bg-white dark:bg-gray-900">
            ...
            <h3 className="text-lg font-bold text-blue-900 dark:text-blue-400 mt-10">
              Localização Maps
            </h3>
