...
export default function AcceptedMatchesList({ matches, onView }: AcceptedMatchesListProps) {
  return (
    <section className="space-y-3">
      ...
      <div className="space-y-3">
        {matches.map((match) => (
          <div
            key={match.id}
            className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-lg border border-border bg-white dark:bg-gray-800 p-5 animate-fade-in shadow-sm"
          >
